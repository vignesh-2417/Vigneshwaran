...
const CLASSIFICATION_RULES = [
  ...
  },
  {
    ...
    patterns: [
      ...
      /entity is deleted/i,
      /cannot be found/i,
      /cannot update the field/i,
      /do not have edit access/i,
      /custom permission/i,
    ],
    weight: 10,
  },
  {
    ...
    patterns: [
      /FUNCTIONALITY_NOT_ENABLED/i,
      /user license/i,
      /license type/i,
      /not enabled for your user license/i,
      /license limit exceeded/i,
      /requires an additional license/i,
      /edition does not include/i,
      /feature is not available/i,
      /not available in your salesforce edition/i,
      /installed package requires/i,
    ],
    weight: 11,
  },
  {
